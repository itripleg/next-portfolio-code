export const responses = {
  ...
  swear: [
    ...
    "You're lucky my boss told me to play nice.",
    ...
    "Hey now.",
    "C U Next Tuesday.",
    "I'm not the only one that dislikes you.",
    "Have you gained weight?",
    "Did you know I also do IT work in hell? I'll make sure your tech doesn't work when you get there.",
  ],
  secret: [
  ...
  cat: [
    ...
    "If you see the same gif, it means you're asking me for too much. Chill out and ask later.",
    "I get these from cataas.com.",
  ],
  jb: [
    ...
    "Nerd. These emojis remind me of him. 👨🏾‍💻🎮🎸🃏🛹🎯🍆🧙🏾‍♂️🚀📈🌚",
  ],
  ...
  rachel: [
    ...
    "So, you're the one with sassy hips and broulders?",
    "Tequila?",
    ...
    "👉🏾👌🏻. I don't know what that means but Boss told me to send it.",
  ],
  bern: [
    "Berenice is the one Boss always beats at ping pong, right?",
    "🏓🦖",
    "Is that your name?",
    "Boss tells me a lot about you.",
    "I was told me to tell you you're cute? Whatever, just doing my job.",
    "Are you Berenice? Boss has been looking for you.",
  ],
  common: ["Where have I heard that before?", "Hmmm...that sounds familiar."],
};
