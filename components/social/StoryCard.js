...
function StoryCard({name, src, profile}) {
	return (
		...
		transistion duration-200 transform ease-in hover:scale-105 hover:animate-pulse">
			<Image className="absolute opacity-0 lg:opacity-100 rounded-full z-10 top-10"
				src={profile}
				width={40}
				height={40}
				layout="fixed"
