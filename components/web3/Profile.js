      ...
      <>
        <div className="h-screen bg-gray-900 p-2 md:p-20 ">
          ...
          <div className=" grid md:flex justify-items-center gap-4 flex-col md:flex-row md:justify-between">
            <h1 className="text-green-300 pt-3 m-4 animate-pulse">
              Succesfully authenticated. Welcome back!
            </h1>
            <button
              className=" text-center text-lg text-black bg-red-700
          ...
          {/*Profile Info*/}
          <div
            className="container mx-auto overflow-auto mr-20 mt-20 text-gray-400
